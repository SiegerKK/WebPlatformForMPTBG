...
13. [PR 1 — финальный контракт](#13-pr-1--финальный-контракт)
14. [PR 1 — детальные implementation decisions](#14-pr-1--детальные-implementation-decisions)
...
## 14. PR 1 — детальные implementation decisions

### 14.1. Структура новых файлов
...
### 14.5. Точка вставки PlanMonitor в tick_zone_map
...
### 14.8. Двойной проход в одном тике (guard)
...
### 14.10. Interrupt thresholds (интеграция с intents.py)
...
### 14.14. Memory запись при abort travel
...
### 14.15. brain_trace coverage acceptance
...
### 14.19. Итоговый план Backend PR 1
...
### 14.20. Итоговый план Frontend PR 1
