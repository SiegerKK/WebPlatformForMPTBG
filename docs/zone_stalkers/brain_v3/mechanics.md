...
- Full hunt operation (intercept, ambush, stakeout) is planned but not yet implemented — see [`../../archive/combat_encounter_system_pr_implementation.md`](../../archive/combat_encounter_system_pr_implementation.md).
