...
- Full hunt operation (intercept, ambush, stakeout) is planned but not yet implemented — see [`../future/combat_encounter_system_pr_implementation.md`](../future/combat_encounter_system_pr_implementation.md).
